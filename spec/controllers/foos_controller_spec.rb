  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved foo as @foo" do
        ...
        post :create, {:foo => { "name" => "invalid value" }}, valid_session
        assigns(:foo).should be_a_new(Foo)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested foo" do
        ...
        Foo.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => foo.to_param, :foo => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the foo as @foo" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Foo.any_instance.stub(:save).and_return(false)
        put :update, {:id => foo.to_param, :foo => { "name" => "invalid value" }}, valid_session
        assigns(:foo).should eq(foo)
      end
